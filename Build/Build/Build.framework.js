...
var ASM_CONSTS = {
  5898048: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 5898109: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 5898173: function() {return Module.webglContextAttributes.powerPreference;},  
 5898231: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 5898286: function($0) {performance.now = function() { return $0; };},  
 5898334: function($0) {performance.now = function() { return $0; };},  
 5898382: function() {performance.now = Module['emscripten_get_now_backup'];}
};
  ...
  function _initializeConvaiClient(apiKey, characterId, enableAudioRecorder, enableAudioPlayer, actionConfig, templateKeys) {
  ...
  function _sendTriggerData(name, message, preload = false) {
  ...
  function _setActionConfig(config) {
...
var asmLibraryArg = {
  ...
  "sendTriggerData": _sendTriggerData,
  "setActionConfig": _setActionConfig,
